...
const categories = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'childrens_activities_entertainment',
        label: 'Children’s Activities & Entertainment',
        children: [
          { value: 'outdoor_playground_park', label: 'Outdoor Playground/Park' },
          { value: 'kids_party_venue', label: 'Kids’ Party Venue' },
          { value: 'educational_play_venue', label: 'Educational Play Venue' },
          { value: 'museum_exhibit_kids', label: 'Museum/Exhibit for Kids' },
          { value: 'family_entertainment_center', label: 'Family Entertainment Center' },
          { value: 'kids_sports_activity_center', label: 'Kids’ Sports or Activity Center' },
          { value: 'other_childrens_entertainment', label: 'Other' },
        ],
      },
    ],
  },
