      ...
      {isOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 transition-opacity" onClick = {() => setIsOpen(false)}>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <div className="grid bg-gray-900 text-white rounded-md shadow-lg border-2 border-orange-500 relative w-full max-w-4xl h-full overflow-hidden" onClick={(e) => e.stopPropagation()}>
