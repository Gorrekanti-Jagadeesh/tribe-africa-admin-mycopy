    ...
    >
      <div id="welcome-content" className="grid gap-8 p-4">
        ...
        <div id="about-africa" className="grid gap-3">
          ...
          <p>
            A treasure trove of untapped potential for tourism and business. At her core is a young, vibrant population,
            brimming with entrepreneurial spirit; some of the most naturally born Entrepreneurs in the world.
          </p>
          <p>
      ...
      <div className="grid justify-content-center h-full md:max-w-96">
        <div className="grid grid-cols-2 gap-4">
          {/* Top Left Image */}
          <div>
            <img src={welcomeImage1} alt="Person in suit" className="w-full h-full object-cover rounded-lg shadow-lg" />
          </div>
